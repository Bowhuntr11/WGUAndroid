...
public class TermInfo extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                alertD.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
                {
                    ...
                    Log.d("TermInfo Dialog", String.valueOf(c2.get(Calendar.YEAR)));
                        ...
                        if (cName.isEmpty() || cProgress.isEmpty() || mName.isEmpty() || mNumber.isEmpty() || mEmail.isEmpty()
                            ...
                            Toast.makeText(TermInfo.this, "You didn't fill out all the information, or the date is too far in the past", Toast.LENGTH_LONG).show();
                        } else {
                            insertCourse(cName, cProgress, c1, c2, mName, mNumber, mEmail);
                            alertD.dismiss();
                            refreshAdapter();
                            Toast.makeText(TermInfo.this, " New Course added ! ", Toast.LENGTH_LONG).show();
                        }
                    }
                });
                ...
                spinnerAdapter = ArrayAdapter.createFromResource(TermInfo.this,
