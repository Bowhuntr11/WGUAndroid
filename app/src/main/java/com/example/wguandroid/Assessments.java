...
public class Assessments extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater layoutInflater = LayoutInflater.from(Assessments.this);
                View promptView = layoutInflater.inflate(R.layout.add_assessment_dialog, null);

                final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Assessments.this);
                ...
                goalDate.setOnClickListener(new View.OnClickListener() {
                                                 ...
                                                 public void onClick(View v) {
                                                     DatePickerDialog dpd = new DatePickerDialog(Assessments.this,
                ...
                alertD.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v) {
                        ...
                        if (aName.isEmpty() || c1.get(Calendar.YEAR) <= 1900) {
                            Toast.makeText(Assessments.this, "You didn't fill out all the information, or the date is too far in the past", Toast.LENGTH_LONG).show();
                        } else {
                            insertAssessment(aName, c1);
                            alertD.dismiss();
                            refreshAdapter();
                            Toast.makeText(Assessments.this, " New Assessment added ! ", Toast.LENGTH_LONG).show();
                        }
                    }
                });
